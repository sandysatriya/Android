...
public class AdapterhkPascal extends FragmentPagerAdapter {

    final int PAGE_COUNT = 2;
    final Context context;

    public AdapterhkPascal(FragmentManager fm, Context context) {
        super(fm);
    ...
    public Fragment getItem(int position) {
        ...
        switch (position){
            case 0:
                fragment = Fragment1_hk_Pascal.newInstance();
                break;
            case 1:
                fragment = Fragment2_hk_Pascal.newInstance();
                break;
        }

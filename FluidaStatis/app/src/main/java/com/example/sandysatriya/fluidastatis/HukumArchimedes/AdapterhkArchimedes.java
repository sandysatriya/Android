...
public class AdapterhkArchimedes extends FragmentPagerAdapter {

    final int PAGE_COUNT = 2;
    final Context context;

    public AdapterhkArchimedes(FragmentManager fm, Context context) {
        super(fm);
    ...
    public Fragment getItem(int position) {
        ...
        switch (position){
            case 0:
                fragment = Fragment1_hk_Archimedes.newInstance();
                break;
            case 1:
                fragment = Fragment2_hk_Archimedes.newInstance();
                break;
        }
